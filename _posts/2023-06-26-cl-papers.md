...
For the difficulty schedule, you choose some heuristic that you think his a good measure of difficulty. For NLP, where CL was first employed, metrics include sentence length, word rarity, entropy (by some measure), and so on.
...
$$ \lambda_{\text{root-p}}(t) = \text{min} \left( 1, \sqrt{\frac{1 - \lambda_0^2}{T_{\text{grow}}} \dot t + \lambda_0^2 } \right)$$.
