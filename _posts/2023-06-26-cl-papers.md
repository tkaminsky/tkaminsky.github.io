...
[A Survey On Curriculum Learning](#a-survey-on-curriculum-learning)[^1] (2021)

[Automatic Goal Generation for Reinforcement Learning Agents](#automatic-goal-generation-for-reinforcement-learning-agents)[^2] (2018)

[Emergent Complexity and Zero-shot Transfer via Unsupervised Environment Design](#emergent-complexity-and-zero-shot-transfer-via-unsupervised-environment-design)[^3] (2020)

[CASSL: Currriculum Accelerated Self-Supervised Learning](#cassl-currriculum-accelerated-self-supervised-learning)[^4] (2018)

[Asymmetric Self-Play For Automatic Goal Discovery in Robotic Manipulation](#asymmetric-self-play-for-automatic-goal-discovery-in-robotic-manipulation)[^5] (2021)

[CLUTR: Curriculum Learning via Unsupervised Task Representation Learning](#clutr-curriculum-learning-via-unsupervised-task-representation-learning)[^6] (2023)

[Intrinsic Motivation and Automatic Curricula via Asymmetric Self-Play](#intrinsic-motivation-and-automatic-curricula-via-asymmetric-self-play)[^7] (2018)

[Teacher Algorithms for Curriculum Learning of Deep RL in Continuously Parametrized Environments](#teacher-algorithms-for-curriculum-learning-of-deep-rl-in-continuously-parametrized-environments)[^8] (2019)
...
* **Task**: For some agent with a high-dimensional control space, it can be difficult to learn 
...
[^3]: [Emergent Complexity and Zero-shot Transfer via Unsupervised Environment Design](https://arxiv.org/abs/2012.02096)

[^4]: [CASSL: Currriculum Accelerated Self-Supervised Learning](https://arxiv.org/abs/1708.01354)

[^5]: [Asymmetric Self-Play For Automatic Goal Discovery in Robotic Manipulation](https://arxiv.org/abs/2101.04882)

[^6]: [CLUTR: Curriculum Learning via Unsupervised Task Representation Learning](https://arxiv.org/abs/2210.10243)

[^7]: [Intrinsic Motivation and Automatic Curricula via Asymmetric Self-Play](https://arxiv.org/abs/1703.05407)

[^8]: [Teacher Algorithms for Curriculum Learning of Deep RL in Continuously Parametrized Environments](https://arxiv.org/abs/1910.07224)
